<x-layout>
    <div>
        <div class="relative m-10 flex w-full max-w-xs flex-col justify-center items-center overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
            ...
            <div class="mt-4 px-5 pb-5 ">
              ...
              <div class="mt-2 mb-5 flex items-center justify-between">
                <p>
                  ...
                  <span class="text-sm text-slate-900 line-through">$399</span>
                </p>
              ...
              <a href="/checkout" class="flex items-center justify-center rounded-md bg-gray-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
