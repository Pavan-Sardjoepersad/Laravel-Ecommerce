            ...
            <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                    <img class="m-2 h-24 w-28 rounded-md border object-cover object-center"
                        src="/images/white-watch.jpg" alt="alternate text"
                        alt="" />
                    <div class="flex w-full flex-col px-4 py-4">
                        <span class="font-semibold">Smart Watch - Super Light</span>
                        <span class="float-right text-gray-400">Color - White</span>
                ...
                <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                    ...
                    <div class="flex w-full flex-col px-4 py-4">
                        ...
                        <p class="mt-auto text-lg font-bold">$209</p>
                    </div>
                </div>
            </div>
            ...
            <form class="mt-5 grid gap-6">
                <div class="relative">
                    ...
                    <label
                        ...
                        for="radio_1">
                        <img class="w-14 object-contain" src="https://www.dhlexpress.nl/sites/default/files/styles/grid_image_1x/public/content/images/DHL-express-logo-recatangle.png?itok=vLlxrBL0" alt="" />
                        <div class="ml-5">
                ...
                <div class="relative">
                    ...
                    <label
                        class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                        for="radio_2">
                        <img class="w-14 object-contain" src="https://logo.com/image-cdn/images/kts928pd/production/c423a9d143ae2a03c1e7076e9abf851a19fceaec-1600x900.png?w=1080&q=72" alt="" />
                        <div class="ml-5">
            ...
            <div class="">
                ...
                <div class="mt-6 border-t border-b py-2">
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold text-gray-900">$358.99</p>
                    </div>
                    <div class="flex items-center justify-between">
                ...
                <div class="mt-6 flex items-center justify-between">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">$366.99</p>
                </div>
            </div>
            <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">Place
                Order</button>
        </div>
    </div>
