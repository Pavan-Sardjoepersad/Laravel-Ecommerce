                    ...
                    <div class="md:flex md:items-center md:gap-12">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="sm:flex sm:gap-4">
                                <a class="inline-block rounded border border-indigo-600 bg-indigo-600 px-10 py-2 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500"
                                    href="/">
                                    Login
                                </a>
                                ...
                                <div class="hidden sm:flex">
                                    ...
                                    <a class="inline-block rounded border border-indigo-600 px-10 py-2 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
                                        href="/">
                                        Register
                                    </a>
                                </div>
